...
public class UserMapperTest {
    ...
    public void updateTest() {
        ...
        userMapper.updateSelective(user, user);
        userMapper.updateByPrimaryKeyList(Arrays.asList(10055L, 10056L), user);
        userMapper.updateSelectiveList(Arrays.asList(user, user), user);
    }

    @Test
    public void selectTest() {
        // userMapper.selectByPrimaryKey(10043L);
        User user0 = User.builder()
                .userId(10055L)
                .build();
        List<User> user = userMapper.selectSelective(user0);
        // userMapper.selectBatchIds(Arrays.asList(10055L, 10056L));
        // userMapper.selectSelectiveList(Arrays.asList(user0, user0));
    }
}